  ...
  isaac_ros2_messages__srv__IsaacPose_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    isaac_ros2_messages__srv__IsaacPose_Request * data =
      (isaac_ros2_messages__srv__IsaacPose_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!isaac_ros2_messages__srv__IsaacPose_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          isaac_ros2_messages__srv__IsaacPose_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  isaac_ros2_messages__srv__IsaacPose_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    isaac_ros2_messages__srv__IsaacPose_Response * data =
      (isaac_ros2_messages__srv__IsaacPose_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!isaac_ros2_messages__srv__IsaacPose_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          isaac_ros2_messages__srv__IsaacPose_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
