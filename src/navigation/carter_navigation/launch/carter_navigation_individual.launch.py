...
def generate_launch_description():
    ...
    nav2_launch_dir = os.path.join(carter_nav2_bringup_dir,"launch","nav2_origin")
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        "map",
        default_value=os.path.join(nav2_launch_dir, "maps", "carter_warehouse_navigation"),
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        "params_file",
        default_value=os.path.join(nav2_launch_dir, "params", "carter_navigation_params.yaml"),
